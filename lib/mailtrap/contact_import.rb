...
module Mailtrap
  ...
  # @attr_reader created_contacts_count [Integer] Number of contacts created in this import
  # @attr_reader updated_contacts_count [Integer] Number of contacts updated in this import
  # @attr_reader contacts_over_limit_count [Integer] Number of contacts over the allowed limit
